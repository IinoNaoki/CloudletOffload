...
print "Dumping...",
pickle.dump(expnum, open("../results/PEN_changing/expnum","w"))
pickle.dump(ParamsSet, open("../results/PEN_changing/Paramsset","w"))
pickle.dump(PEN_list, open("../results/PEN_changing/xaxis","w"))
pickle.dump(RESset_bell, open("../results/PEN_changing/bell","w"))
pickle.dump(RESset_myo, open("../results/PEN_changing/myo","w"))
pickle.dump(RESset_rnd, open("../results/PEN_changing/rnd","w"))
pickle.dump(RESset_zero, open("../results/PEN_changing/zero","w"))
pickle.dump(RESset_one, open("../results/PEN_changing/one","w"))
pickle.dump(V_opt_set_bell, open("../results/PEN_changing/V_opt_bell","w"))
pickle.dump(A_opt_set_bell, open("../results/PEN_changing/A_opt_bell","w"))
print "Finished"